"""
Django settings for sistickets project.
...
SECRET_KEY = 'p@#aq4ig^2w-%b=a$l6ml2g2s^)32dl34)4dan=ei$)2k%ug14'
...
WSGI_APPLICATION = 'sistickets.wsgi.application'
